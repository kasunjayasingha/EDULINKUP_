...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Student Profile Edit
      </h6>
  ...
  <div class="col-6">
    ...
    <textarea class="form-control mb-3" name="uaddress" aria-label="With textarea" id="addressID"><?php echo $row['address']; ?></textarea>
  </div>
  <?php
}
}
...
if (isset($_POST['editstudentBtn'])) {
  ...
  <div class="modal-footer">
    ...
    <button type="submit" id="liveToastBtn" name="updateStudentBtn" class="btn btn-primary">Update</button>
  </div>
  </div>
</form>
<?php
